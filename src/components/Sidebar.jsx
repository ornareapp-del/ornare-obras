...
export default function Sidebar({ collapsed, setCollapsed, isMobile }) {
  ...
  return (
    <aside style={{
      ...
      {/* Logo */}
      <div style={{
        padding: collapsed && !isMobile ? '18px 0' : '14px 16px 12px',
        ...
        {(!collapsed || isMobile) && (
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', overflow: 'hidden', minWidth: 0, flex: 1, height: 42 }}>
            <img
              src="/logo-ornare.png"
              alt="Ornare Works"
...
function IconTruck()        { return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 6h11v11H3z"/><path d="M14 10h4l3 3v4h-7z"/><circle cx="7" cy="18" r="2"/><circle cx="18" cy="18" r="2"/></svg> }
