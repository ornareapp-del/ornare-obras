...
.sheet-overlay{justify-content:center;align-items:flex-start;padding:22px;overflow:auto}.delivery-sheet{width:min(920px,100%);background:#f8f5ef;color:#28231e;border-radius:4px;box-shadow:0 24px 80px #000b;padding:34px 38px;margin:auto}.sheet-head{display:flex;justify-content:space-between;gap:25px;border-bottom:4px solid ${LARANJA};padding-bottom:20px}.sheet-brand{font-size:31px;letter-spacing:4px;font-weight:300}.sheet-head h2{font-family:var(--font-serif);font-size:34px;margin:10px 0 3px}.sheet-head p{color:#766d64;margin:0}.sheet-head-actions{display:flex;align-items:flex-start;gap:12px}.sheet-head .close{color:#28231e}.sheet-highlight{display:grid;grid-template-columns:1.4fr 1fr 1fr;gap:10px;margin:22px 0}.sheet-highlight>div,.sheet-info{border:1px solid #ddd5ca;background:#fff;border-radius:9px;padding:12px}.sheet-highlight small,.sheet-info small{display:block;color:#81766b;font-size:9px;letter-spacing:1.1px;text-transform:uppercase;font-weight:900;margin-bottom:5px}.sheet-highlight strong,.sheet-info strong{display:block;font-size:13px;line-height:1.45}.sheet-route{display:grid;grid-template-columns:1fr 35px 1fr;gap:8px;align-items:center;margin-bottom:10px}.sheet-route>b{text-align:center;color:${LARANJA};font-size:22px}.sheet-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.sheet-blocks{display:grid;gap:10px;margin-top:10px}.sheet-foot{display:flex;justify-content:space-between;align-items:flex-end;gap:20px;border-top:1px solid #ddd5ca;margin-top:24px;padding-top:18px}.sheet-foot>div:first-child{display:grid;color:#81766b;font-size:10px;gap:3px}.sheet-buttons{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end}.sheet-buttons>button:not(.primary){border:1px solid #cfc5b8;background:#fff;color:#302a24;border-radius:8px;padding:11px 14px;font-weight:900}@media(max-width:800px){.sheet-overlay{padding:0}.delivery-sheet{min-height:100%;padding:22px 16px}.sheet-head{gap:8px}.sheet-head h2{font-size:27px}.sheet-brand{font-size:24px}.sheet-highlight,.sheet-grid{grid-template-columns:1fr}.sheet-route{grid-template-columns:1fr}.sheet-route>b{transform:rotate(90deg)}.sheet-foot{align-items:stretch;flex-direction:column}.sheet-buttons button{flex:1}.sheet-head-actions .badge{display:none}}
`
